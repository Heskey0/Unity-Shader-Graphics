...
[VolumeComponentMenu("CustomPost/Blur/IrisBlur")]
public class CustomIrisBlur : PostVolumeComponentBase
{
    ...
    public ClampedFloatParameter _Offset = new ClampedFloatParameter(0.0f, 0.0f, 1.0f); 
    ...
    public override void Setup()
    {
        if (_material == null)
        {
            _material = CoreUtils.CreateEngineMaterial("CustomPost/Blur/IrisBlur");
        }
    }
